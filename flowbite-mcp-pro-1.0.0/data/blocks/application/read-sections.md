...
## Read product section with carousel

Use this page section to show details of a product from your database including images inside a carousel slider, description, color tabs, categories, and other information.
  ...
  <div class="py-8 px-4 mx-auto max-w-6xl lg:py-16">
      ...
      <div class="grid gap-4 mb-4 sm:grid-cols-3 sm:gap-6 md:gap-12 sm:mb-5">
          ...
          <div class="sm:col-span-2">
              <div id="default-carousel" class="relative mb-4 sm:mb-5" data-carousel="slide">
                  <!-- Carousel wrapper -->
                  <div class="overflow-hidden relative h-56 rounded-lg md:h-96">
                      <!-- Item 1 -->
                      <div class="absolute inset-0 z-20 bg-gray-100 transition-all duration-700 ease-in-out transform translate-x-0 dark:bg-gray-700" data-carousel-item="">
                          <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-side-image.png" class="block absolute top-1/2 left-1/2 h-80 -translate-x-1/2 -translate-y-1/2" alt="Imac side">
                      </div>
                      <!-- Item 2 -->
                      <div class="absolute inset-0 z-10 bg-gray-100 transition-all duration-700 ease-in-out transform translate-x-full dark:bg-gray-700" data-carousel-item="">
                          <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-front-image.png" class="block absolute top-1/2 left-1/2 h-80 -translate-x-1/2 -translate-y-1/2" alt="Imac front">
                      </div>
                      <!-- Item 3 -->
                      <div class="absolute inset-0 z-10 bg-gray-100 transition-all duration-700 ease-in-out transform -translate-x-full dark:bg-gray-700" data-carousel-item="">
                          <img src="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-back-image.png" class="block absolute top-1/2 left-1/2 h-80 -translate-x-1/2 -translate-y-1/2" alt="Imac back">
                      </div>
                  </div>                        
                  <!-- Slider controls -->
                  <button type="button" class="flex absolute top-0 left-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev="">
                      <span class="inline-flex justify-center items-center w-8 h-8 bg-gray-200 rounded-full sm:w-10 sm:h-10 dark:bg-gray-600 group-hover:bg-gray-300 dark:group-hover:bg-gray-500 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                          <svg aria-hidden="true" class="w-5 h-5 text-gray-500 sm:w-6 sm:h-6 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                          <span class="sr-only">Previous</span>
                      </span>
                  </button>
                  <button type="button" class="flex absolute top-0 right-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-next="">
                      <span class="inline-flex justify-center items-center w-8 h-8 bg-gray-200 rounded-full sm:w-10 sm:h-10 dark:bg-gray-600 group-hover:bg-gray-300 dark:group-hover:bg-gray-500 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                          <svg aria-hidden="true" class="w-5 h-5 text-gray-500 sm:w-6 sm:h-6 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                          <span class="sr-only">Next</span>
                      </span>
                  </button>
              </div>
              <p class="mb-4 font-light text-gray-500 dark:text-gray-400 sm:mb-5">See it all in sharp, glorious detail on the immersive 24‑inch 4.5K Retina display.2 The P3 wide color gamut brings what you’re watching to life in over a billion colors. Images shine with a brilliant 500 nits of brightness. Industry-leading anti‑reflective coating delivers greater comfort and readability.</p>
              <dl>
                  <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Details</dt>
                  <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass ,3.8GHz 8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic Keyboard - US.</dd>
          ...
          <div>
              <dl>
                  ...
                  <dd class="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">Apple</dd>
                  <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Dimensions (cm)</dt>
                  <dd class="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">105 x 15 x 23</dd>
                  <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Item weight</dt>
...
Use this CRUD layout section to show details about an existing user from the database including their name, biography, location, and other CRUD action buttons for editing and deletion.

```html
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <h2 class="mb-4 text-xl font-semibold leading-none text-gray-900 md:text-2xl dark:text-white sm:mb-5">Helene Engels</h2>
      <dl>
          <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Biography</dt>
          <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">UI/UX Designer, Creating things that stand out, Featured by Adobe, Figma, Webflow and others, Daily design tips & resources, Exploring Web3.
          </dd>
...
## Advanced read user section

This example can be used to show detailed information about an existing user from the database based on a CRUD layout website section.
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 mx-auto max-w-6xl lg:py-16">
        <div class="grid gap-4 px-4 mb-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
            ...
            <div class="sm:col-span-2">
                <div class="flex items-center space-x-4">
                    <img class="mb-4 w-16 h-16 rounded-full sm:w-20 sm:h-20" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Helene avatar">
                    <div>
                        <h2 class="flex items-center mb-2 text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">
                            Helene Engels
                            <span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300 uppercase ml-2.5">Pro</span>
                        </h2>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 mb-4 sm:mb-5">
            ...
            <dl>
                ...
                <dd class="font-light text-gray-500 dark:text-gray-400">English, French, Spanish</dd>
            </dl>
            </div>
...
Use this example to show basic information about an event data entry from the database.

```html
<section class="py-8 bg-white lg:py-16 dark:bg-gray-900">
  <div class="max-w-2xl px-4 mx-auto">
      ...
      <dl class="mb-4 sm:mb-5">
          <dt class="mb-2 font-medium leading-none text-gray-900 dark:text-white">Details:</dt>
...
## Advanced read event section

Use this website section to show more advanced details about an event from your database, such as invited guests, details, location, and more.
      ...
      <div class="grid gap-4 px-4 mb-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
          ...
          <dl class="p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
              ...
              <dd class="flex mb-4 -space-x-4 sm:mb-5">
                  <img class="w-8 h-8 rounded-full border-2 border-gray-50 dark:border-gray-700" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Helene Engels">
                  <img class="w-8 h-8 rounded-full border-2 border-gray-50 dark:border-gray-700" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/robert-brown.png" alt="Robert Brown">
                  <img class="w-8 h-8 rounded-full border-2 border-gray-50 dark:border-gray-700" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Green">
                  <button type="button" class="flex justify-center items-center w-8 h-8 text-xs font-medium text-white bg-gray-600 rounded-full border-2 border-gray-50 hover:bg-gray-500 dark:border-gray-700">+9</button>
              </dd>
