...
## Event schedule with speakers and sponsors

This example can be used to show two columns of a timeline presenting the workshop title, a short description, the speakers, and even the sponsors of the event.
...
## Event schedule timeline three columns

Use this example to show the schedule of the event based on a timeline for each day featuring the timing, title, speakers, and sponsors of the workshop.
...
Use this advanced example to break up the schedule of the days using the tab component and feature the timeline of the event showing the title, speakers, and sponsors.
...
```javascript
// Learn more about the Flowbite Tabs API here: https://flowbite.com/docs/components/tabs/#javascript-behaviour

const tabElements = [
  {
    id: 'day1',
    triggerEl: document.querySelector('#day1-tab'),
    targetEl: document.querySelector('#day1')
  },
  {
    id: 'day2',
    triggerEl: document.querySelector('#day2-tab'),
    targetEl: document.querySelector('#day2')
  },
  {
    id: 'day3',
    triggerEl: document.querySelector('#day3-tab'),
    targetEl: document.querySelector('#day3')
  }
];
...
const options = {
  defaultTabId: 'day1',
  activeClasses: 'bg-primary-600 text-white dark:bg-primary-500',
  inactiveClasses: 'bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400'
};
