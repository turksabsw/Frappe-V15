  ...
  <div class="space-y-4">
    ...
    <div v-if="hasContent" class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-pim-text">
    ...
    <div v-if="hasContent" class="grid grid-cols-2 gap-2">
      <div
        ...
        :key="channel.id"
        class="relative overflow-hidden rounded-lg border bg-white p-3 transition-shadow hover:shadow-sm"
        :class="channel.is_primary ? 'border-primary-300 ring-1 ring-primary-100' : 'border-gray-100'"
      >
        <!-- Primary Badge -->
        <span
          v-if="channel.is_primary"
          class="absolute right-1.5 top-1.5 rounded-full bg-primary-100 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-primary-700"
        >
          Primary
        </span>
        ...
        <div class="mt-1 flex items-center gap-1">
          ...
          <span class="text-[10px] text-pim-muted">Active</span>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <p class="text-sm text-pim-muted">Select your sales channels to see the dashboard</p>
    </div>
  </div>
</template>
