 ...
 *
 * Renders a company info card showing:
 ...
 * - Pain points tags
 *
 * Updates in real time as the user fills in the CompanyInfoStep form.
...
/** Human-readable company size labels */
...
/** Human-readable existing system labels */
...
/** Human-readable pain point labels */
  ...
  <div class="space-y-4">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      <div class="flex items-start gap-3">
        <!-- Company Avatar -->
        <div
          class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-primary-100 text-lg font-bold text-primary-700"
        >
        ...
        <div class="min-w-0 flex-1">
          <!-- Company Name -->
          <h3 class="truncate text-base font-semibold text-pim-text">
          ...
          <p
            ...
            class="mt-0.5 truncate text-xs text-primary-600"
          >
    ...
    <!-- Existing Systems -->
    <div v-if="data.existing_systems.length > 0" class="rounded-lg border border-gray-100 bg-white p-4">
    ...
    <!-- Pain Points -->
    <div v-if="data.pain_points.length > 0" class="rounded-lg border border-gray-100 bg-white p-4">
      <h4 class="mb-2 text-xs font-medium uppercase tracking-wider text-pim-muted">
        Key Challenges
      </h4>
      <div class="flex flex-wrap gap-1.5">
        <span
          ...
          :key="point"
          class="inline-flex items-center rounded-full bg-amber-50 px-2.5 py-1 text-xs text-amber-700"
        >
    ...
    >
      ...
      <p class="text-sm text-pim-muted">Start filling in your company details</p>
    </div>
  </div>
</template>
